            ...
            <div>
                <div class="grid w-full gap-6">
                    <div>
                        ...
                        <div v-if="validates.title" class="pt-2 text-red-600"> {{ validates.title }} </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div v-if="validates.price" class="pt-2 text-red-600"> {{ validates.price }} </div>
                    </div>

                    <div>
                        <default-label for="status">Category Name</default-label>
                        <input-ui id="price" ref="price" type="text" v-model:value="form.category" />
                        <div v-if="validates.category" class="pt-2 text-red-600"> {{ validates.category }} </div>
                    </div>

                    <div>
                        <default-label for="description">Description</default-label>
                    ...
                    <div class="flex justify-end mb-4 space-x-2">
                        ...
                        <button-loading bgColor="bg-gray-500" @click="submitAddItem">Save</button-loading>
                    </div>
                </div>
            </div>
        </div>
...
function submitAddItem() {
    console.log(form);
    axios.post(`http://127.0.0.1:8000/api/items/add`, {
        title: form.title,
